...
<h2>Who We Are?</h2>
<span class="brk"></span>
<p>Mobigo Indias Ultimate Online Shopping Destination Mobigos vision is to create Indias most reliable and frictionless commerce ecosystem that creates life-changing experiences for buyers and sellers. In jan 2017, Anil choppari started Mobigo.com - India’s largest online marketplace for Mobiles and smartphones, with the widest range of products and diverse categories from over regional, national, and international brands and retailers. With so many of users.
</div>
</div>
...
<div class="row">
    ...
    <div class="thumbnail">
      ...
      <div class="caption">
        <h3>Choppari Anil</h3>
        <p class="card-description">Choppari Anil is an Indian software engineer and Internet entrepreneur. In 2017 he founded the e-commerce platform Mobigo.In January 2017 he is Group CEO[1] of Mobigo.</p>
