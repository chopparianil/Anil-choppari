...
<div class="container">
			<div class="row main">
				<div class="main-login main-center">
						<form:form action="addcategory" method="post" commandName="categoryForm">
						
						<div class="form-group">
							<label for="category id" class="cols-sm-2 control-label">CATEGORY ID</label>
						...
						<div class="form-group">
							<label for="category description" class="cols-sm-2 control-label">CATEGORY DESCRIPTION</label>
							<div class="cols-sm-10">
								<div class="input-group">
                    ...
                    <td colspan="2" align="center"><input type="submit" class="form-control" value="addcategory" /></td>
                </div>
